...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-10 w-auto" src="/IMG_9570.png" alt="YazanMart">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" on:submit|preventDefault={register}>
        {#if !success && success !== null}
            <div class="p-8 text-red-500 bg-red-100">There was an error registering. Please try again. Error message: {errorMessage}</div>
        {/if}
        <div>
